...
class FirmwareUpdateServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.ApplyFirmwareUpdate = channel.unary_unary(
                '/IotDeviceManagement2.FirmwareUpdateService/ApplyFirmwareUpdate',
                request_serializer=device__pb2.ApplyFirmwareUpdateRequest.SerializeToString,
                response_deserializer=device__pb2.ApplyFirmwareUpdateRequest.FromString,
                _registered_method=True)
...
def add_FirmwareUpdateServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ApplyFirmwareUpdate': grpc.unary_unary_rpc_method_handler(
                    servicer.ApplyFirmwareUpdate,
                    request_deserializer=device__pb2.ApplyFirmwareUpdateRequest.FromString,
                    response_serializer=device__pb2.ApplyFirmwareUpdateRequest.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'IotDeviceManagement2.FirmwareUpdateService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('IotDeviceManagement2.FirmwareUpdateService', rpc_method_handlers)
...
class FirmwareUpdateService(object):
    ...
    @staticmethod
    def ApplyFirmwareUpdate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/IotDeviceManagement2.FirmwareUpdateService/ApplyFirmwareUpdate',
            device__pb2.ApplyFirmwareUpdateRequest.SerializeToString,
            device__pb2.ApplyFirmwareUpdateRequest.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
